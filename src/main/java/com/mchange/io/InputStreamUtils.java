...
public final class InputStreamUtils
{
  ...
  public static void attemptClose(InputStream is, RobustMessageLogger logger)
	...
	{if (logger != null) logger.log(e, "IOException trying to close InputStream");}
      catch (NullPointerException e)
	{if (logger != null) logger.log(e, "NullPointerException trying to close InputStream");}
    }
